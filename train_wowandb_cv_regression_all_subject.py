...
def run(args: DictConfig) -> None:
    ...
    if args.dataset == "Gwilliams2022":
        ...
        ind_tr = list(range(0, 3000)) + list(range(3600, 6600)) + list(range(7200, 10200)) + list(range(10800, 13800))  + list(range(14400, 17400)) + list(range(18000, 21000))
        ind_te = list(range(3000,3600)) + list(range(6600, 7200))  +list(range(10200,10800)) + list(range(13800, 14400)) + list(range(17400, 18000)) + list(range(21000, 21600))
...
if __name__ == "__main__":
    ...
    with initialize(version_base=None, config_path="../configs/"):
        args = compose(config_name='20230501_sbj01_eegnet_regression')
