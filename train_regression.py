...
def run(args: DictConfig) -> None:
    ...
    optimizer = torch.optim.Adam(
        brain_encoder.parameters(), lr=float(args.lr),
    )
    ...
    for epoch in pbar:
        ...
        for i, batch in enumerate(pbar2):
            ...
            for w in brain_encoder.parameters():
                l2 = l2 + torch.norm(w)**2
            l2 = args.l2_weight * l2
            loss = loss_func(Z, Y)
            ...
            pbar.set_description("training {}/{} iters Train/Loss: {}, Train/L2Loss: {}, Train/Top1Acc: {}, Train/Top10Acc: {}".format(i, len(train_loader), loss.item(), l2.item(), trainTop1acc, trainTop10acc))
            optimizer.zero_grad()
            total_loss = loss + l2
            total_loss.backward()
            optimizer.step()
...
if __name__ == "__main__":
    ...
    with initialize(version_base=None, config_path="../configs/"):
        args = compose(config_name='20230423_sbj01_seq2stat_regression')
